...
var SchoolTripWebsite;
(SchoolTripWebsite||(SchoolTripWebsite = {}));
(function (SchoolTripWebsite) {
const moduleName = `SchoolTripWebsite`;
const _ = {};


let _n;
const Popup = class Popup extends Aventus.WebComponent {
    ...
    get 'vertical'() {
						return this.__watch["vertical"];
					}
					set 'vertical'(val) {
						this.__watch["vertical"] = val;
					}
get 'titleText'() {
						return this.__watch["titleText"];
					}
					set 'titleText'(val) {
						this.__watch["titleText"] = val;
					}
get 'description'() {
						return this.__watch["description"];
					}
					set 'description'(val) {
						this.__watch["description"] = val;
					}
get 'picturePath'() {
						return this.__watch["picturePath"];
					}
					set 'picturePath'(val) {
						this.__watch["picturePath"] = val;
					}
    __registerWatchesActions() {
    this.__addWatchesActions("vertical");
this.__addWatchesActions("titleText");
this.__addWatchesActions("description");
this.__addWatchesActions("picturePath");
    ...
    this.__getStatic().__template.setHTML({
        blocks: { 'default':`<div class="background" _id="popup_0">
    <div class="popup" _id="popup_1">
        <div class="close" _id="popup_2"></div>
        <template _id="popup_3"></template> 
        <div class="separator"></div>
        <div class="descriptionContainer">
            <div class="description" _id="popup_8"></div>
        </div>
    </div>
</div>` }
    });
...
this.__getStatic().__template.setActions({
  "content": {
    "popup_8°@HTML": {
      "fct": (c) => `${c.print(c.comp.__4e99bbf43177f1f767ee3688dddab253method3())}`,
      "once": true
    }
  },
  "events": [
    {
      "eventName": "click",
      "id": "popup_0",
      "fct": (e, c) => c.comp.hide(e)
    },
    {
      "eventName": "click",
      "id": "popup_1",
      "fct": (e, c) => c.comp.preventProp(e)
    },
    {
      "eventName": "click",
      "id": "popup_2",
...
templ0.setTemplate(`
            <div class="line">
                ...
                <div class="title" _id="popup_5"></div>
            </div>
        `);
templ0.setActions({
  "content": {
    "popup_4°src": {
      "fct": (c) => `pictures/${c.print(c.comp.__4e99bbf43177f1f767ee3688dddab253method1())}`,
      "once": true
    },
    "popup_5°@HTML": {
      "fct": (c) => `${c.print(c.comp.__4e99bbf43177f1f767ee3688dddab253method2())}`,
      "once": true
    }
  }
});
...
templ1.setTemplate(`
            <div class="col">
                <div class="title" _id="popup_6"></div>
                <div class="picture">
                    <img alt="" _id="popup_7" />
                </div>
            </div>
...
this.__getStatic().__template.addIf({
                    anchorId: 'popup_3',
                    parts: [{once: true,
                    condition: (c) => c.comp.__4e99bbf43177f1f767ee3688dddab253method0(),
                    template: templ0
                },{once: true,
                    condition: (c) => true,
                    template: templ1
    ...
    __defaultValuesWatch(w) { super.__defaultValuesWatch(w); w["vertical"] = undefined;
w["titleText"] = undefined;
w["description"] = undefined;
w["picturePath"] = undefined;
 }
    __upgradeAttributes() { super.__upgradeAttributes(); this.__upgradeProperty('active');
this.__correctGetter('vertical');
this.__correctGetter('titleText');
this.__correctGetter('description');
this.__correctGetter('picturePath');
 }
    __listBoolProps() { return ["active"].concat(super.__listBoolProps()).filter((v, i, a) => a.indexOf(v) === i); }
    show(title, description, imagePath, vertical = false) {
    ...
    __4e99bbf43177f1f767ee3688dddab253method1() {
        return this.picturePath;
    }
    __4e99bbf43177f1f767ee3688dddab253method2() {
        return this.titleText;
    }
    __4e99bbf43177f1f767ee3688dddab253method3() {
        return this.description;
    }
    __4e99bbf43177f1f767ee3688dddab253method0() {
        return this.vertical;
    }
}
Popup.Namespace=`SchoolTripWebsite`;
Popup.Tag=`av-popup`;
_.Popup=Popup;
...
const TimelineEvent = class TimelineEvent extends Aventus.WebComponent {
    eventTitle = "";
    eventDesc = "";
    eventPicturePath = "";
    eventDate = "";
    ...
    __getStyle() {
        let arrStyle = super.__getStyle();
        arrStyle.push(TimelineEvent.__style);
        return arrStyle;
    }
    __getHtml() {
    this.__getStatic().__template.setHTML({
        blocks: { 'default':`<div class="event" _id="timelineevent_0">
    <div class="point"></div>
...
Des programmes très attractifs donc, avec des conditions très bien aussi. Mais tout ça, ça doit coûter pas mal aux CFF, on comprend donc pourquoi les prix sont si élevés, et on vous promet de profiter aux mieux de nos superbe conditions de travail (payées entre autre par vos tickets de train), dans le cas où les CFFs nous accepterons...
    ...
    __getStyle() {
        let arrStyle = super.__getStyle();
        arrStyle.push(Timeline.__style);
        return arrStyle;
    }
    __getHtml() {
    this.__getStatic().__template.setHTML({
        blocks: { 'default':`<div class="timeline" _id="timeline_0">
</div>` }
    });
}
    __registerTemplateAction() { super.__registerTemplateAction();
...
Timeline.Namespace=`SchoolTripWebsite`;
Timeline.Tag=`av-timeline`;
_.Timeline=Timeline;
...
Main.Namespace=`SchoolTripWebsite`;
Main.Tag=`av-main`;
_.Main=Main;
...
for(let key in _) { SchoolTripWebsite[key] = _[key] }
})(SchoolTripWebsite);
